Info: Optimization for declaration of const-qualified symbol 'ivec3a' of type 'const ivec3' successful at Line 2:5 to Line 2:39.
Info: Optimization for declaration of const-qualified symbol 'ivec3b' of type 'const ivec3' successful at Line 3:5 to Line 3:42.
(SCOPE
    (DECLARATIONS
        ...
        (DECLARATION ivec3a const ivec3 (CALL ivec3 1 2 3))
        (DECLARATION ivec3b const ivec3 (CALL ivec3 2 4 6))
    )
    (STATEMENTS
    )
)
