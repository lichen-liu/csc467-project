Info: Optimization for declaration of const-qualified symbol 'inta' of type 'const int' successful at Line 2:5 to Line 2:24.
Info: Optimization for declaration of const-qualified symbol 'ivec3a' of type 'const ivec3' successful at Line 3:5 to Line 3:61.
(SCOPE
    (DECLARATIONS
        ...
        (DECLARATION inta const int 3)
        (DECLARATION ivec3a const ivec3 (CALL ivec3 5 6 5))
    )
    (STATEMENTS
    )
)
